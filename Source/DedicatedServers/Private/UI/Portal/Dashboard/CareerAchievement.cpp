...
void UCareerAchievement::SetAchievementText(const FString& AchievementName, int32 AchievementValue)
{
...
void UCareerAchievement::SetAchievementIcon(UTexture2D* Icon)
{
